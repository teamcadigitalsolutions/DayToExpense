...
export default function LoansPage() {
  ...
  // Local Storage Smart Loans State
  const [loans, setLoans] = useState<SmartLoanItem[]>(() => {
    ...
    // Initial default example record
    return [
      {
        id: 'loan-sample-1',
        name: 'LG OLED TV No-Cost EMI',
        item_purchased: 'LG 55-Inch Smart OLED TV',
        type: 'NO_COST_EMI',
        institution: 'HDFC Credit Card EMI',
        total_item_cost: 80000,
        down_payment: 20000, // ₹20,000 advance paid
        financed_amount: 60000,
        interest_rate: 0,
        tenure_months: 6,
        emi_amount: 10000,
        total_paid: 20000, // Down payment paid + 0 EMIs paid so far
