...
import { transactionService, accountService, categoryService, reportService } from '../../services';
...
export default function ReportsPage() {
  ...
  // Local Storage Module Data for All-in-One Report Generation
  const projectsData = (() => {
    try {
  ...
  const taxData = (() => {
    try {
      ...
      return saved ? JSON.parse(saved) : {
        financial_year: '2026-2027', taxable_income: 0, sec_80c_investments: 0,
        sec_80d_health: 0, business_expenses: 0, gst_paid: 0,
      };
    } catch {
      return { financial_year: '2026-2027', taxable_income: 0, sec_80c_investments: 0, sec_80d_health: 0, business_expenses: 0, gst_paid: 0 };
    }
  })();
